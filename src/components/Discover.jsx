...
const Discover = () => {
  return (
    <div className='my-8 md:my-12 max-w-[1200px] mx-auto px-2 gap-3 flex flex-col overflow-x-hidden md:flex-row items-center inset-1 rounded-b-xl  shadow-xl drop-shadow-xl shadow-gray-500/70 py-6 '>
